(function ($) {
  ...
  $.fn.wPaint.extend({
    ...
    _addUndo: function () {
      ...
      while (this.undoCurrent !== this.undoArray.length - 1 && this.undoArray.length !== 0) {
        this.undoArray.pop();
      }
    ...
    _drawPencilMove: function (e) {
      ...
      if (this.points.length > 3) {
        ...
        // console.log(lastTwoPoints[0], lastTwoPoints[1])
        var controlPoint = lastTwoPoints[0];
        var endPoint = {
          x: (lastTwoPoints[0].x + lastTwoPoints[1].x) / 2,
          y: (lastTwoPoints[0].y + lastTwoPoints[1].y) / 2,
        }
        this.drawBezierCurve(this.beginPoint, controlPoint, endPoint);
        this.beginPoint = endPoint;
      }
    },

    drawBezierCurve: function (beginPoint, controlPoint, endPoint) {
      // ctx.beginPath();
